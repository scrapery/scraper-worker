...
public class WebConfigurer implements ServletContextInitializer, WebServerFactoryCustomizer<WebServerFactory> {
    ...
    public WebConfigurer(Environment env, SimlifeProperties simLifeProperties) {
    ...
    public void customize(WebServerFactory server) {
         ...
         */
        if (simLifeProperties.getHttp().getVersion().equals(SimlifeProperties.Http.Version.V_2_0) &&
    ...
    public CorsFilter corsFilter() {
        ...
        CorsConfiguration config = simLifeProperties.getCors();
